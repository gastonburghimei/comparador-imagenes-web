CREATE or replace TABLE `meli-bi-data.SBOX_PFFINTECHATO.cta_hacker_test` as 
(
...
from `meli-bi-data.SBOX_PFFINTECHATO.cta_hacker_test` h
 inner join `meli-bi-data.WHOWNER.BT_MP_PAY_PAYMENTS` p
    ...
    and p.pay_move_date >= '2025-02-01'
WHERE 1=1
